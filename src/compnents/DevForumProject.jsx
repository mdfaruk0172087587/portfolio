...
const images = [
    "https://i.ibb.co.com/v6bWLjyS/devforum7.png",
    "https://i.ibb.co.com/zH82r4Js/devslider3.png",
    "https://i.ibb.co.com/4D8NW9B/dev2.png",
    "https://i.ibb.co.com/4ZSBtkSG/dev3.png",
];
const techLogos = {
...
const DevForumProject = () => {
    const project = {
        name: "DevForum - A Modern Discussion Platform",
        mainTech: ["React", "Node.js", "Express", "MongoDB", "Tailwind CSS"],
        description:
            "This project is an online forum for programmers and developers where they can ask questions, discuss topics, and share their experiences. It serves as a community platform for developers.",
        liveLink: "https://magnificent-kulfi-510251.netlify.app/",
        githubClient: "https://github.com/mdfaruk0172087587/devForum",
        challenges:
            "Secure login, accurate tagging, real-time comments and notifications, spam control, and performance optimization were the main challenges.",
        futurePlans:
            "There are plans to add real-time messaging, advanced search, enhanced user management, a mobile app, and AI-based spam control.",
    };
...
export default DevForumProject;